...
<body>
    ...
    <!-- Popular Places -->
    <section class="layout-pt-md layout-pb-md">
        <div data-anim-wrap="" class="container animated" id="index_locations_content">

        </div>
    </section>

    <?php include 'commons/feature.php'; ?>

    <!-- Banner -->
    <section class="layout-pt-md layout-pb-md">
        <div data-anim="slide-up delay-1" class="container">
            <div class="row y-gap-20" id="index_banners_content">
    ...
    <section class="layout-pt-sm layout-pb-md">
        <div data-anim-wrap="" class="container animated" id="index_posts_content">
