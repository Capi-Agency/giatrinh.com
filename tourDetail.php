        ...
        <div class="col-lg-8">
          ...
          <div class="row x-gap-40 y-gap-40">
            ...
            <div class="mt-40 border-top-light">
              <div class="border-bottom-light row x-gap-40 y-gap-40 py-40">
                <div class="col-12">
              ...
              <div class="border-bottom-light row x-gap-40 y-gap-40 py-40">
                <div class="col-12">
                  <h3 class="text-22 fw-500">ĐẶT TOUR</h3>
                </div>
                ...
                <div class="row justify-between items-center pt-15">
                  ...
                  <div class="col-auto">
                    <button class="px-60 py-24 rounded-4 flex-center bg-blue-1">
            ...
            <div class="w-360 lg:w-full d-flex flex-column items-center">
              <div class="px-30 py-30 rounded-4 border-light bg-white shadow-4">
                ...
                <div class="d-flex items-center pt-20">
                  ...
                  <div class="text-14 lh-16 ml-10">Di chuyển: Vietnam airlines</div>
                </div>
                <div class="d-flex items-center pt-20">
                  <div class="size-40 flex-center bg-light-2 rounded-full">
                    <i class="icon-heart text-16 text-green-2"></i>
                  </div>
                  <div class="text-14 lh-16 ml-10">Lịch khởi hành: Tháng 5. 6. 7. 8</div>
                </div>
                <div class="d-flex items-center pt-20">
                  <div class="size-40 flex-center bg-light-2 rounded-full">
                    <i class="icon-heart text-16 text-green-2"></i>
                  </div>
                  <div class="text-14 lh-16 ml-10">Lịch khởi hành: Thứ 5. 6. 7 hàng tuần</div>
                </div>
                <div class="d-flex items-center pt-20">
                  <div class="size-40 flex-center bg-light-2 rounded-full">
                    <i class="icon-heart text-16 text-green-2"></i>
                  </div>
                  <div class="text-14 lh-16 ml-10">Thời gian: 4 ngày 3 đêm</div>
                </div>
                <div class="row justify-between items-center pt-15">
                  <div class="col-auto">
                    <button class="px-30 py-10 rounded-4 flex-center bg-blue-1">
                      <span class="text-14 fw-600 text-white">Đặt tour</span>
                    </button>
                  </div>
                  <div class="col-auto">
                    <button class="px-30 py-10 rounded-4 flex-center bg-blue-1">
                      <span class="text-14 fw-600 text-white">Yêu cầu đặt</span>
                    </button>
                  </div>
                </div>
              </div>
      ...
      <div class="row justify-center">
        <div class="col-auto">
          <div class="sectionTitle -md">
            <h2 class="sectionTitle__title"> CÁC TOUR TƯƠNG TỰ</h2>
          </div>
        </div>
      </div>
