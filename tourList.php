              ...
              <div class="button-grid items-center">
                          ...
                          <button class="-link d-block col-12 text-left rounded-4 px-20 py-15 js-search-option">
                            <div class="d-flex">
                              ...
                              <div class="ml-10">
                                ...
                                <div class="text-14 lh-12 text-light-1 mt-5">Thành phố Hà Nội</div>
                              </div>
                            </div>
                          </button>
                        </div>
                        ...
                        <div>
                          <button class="-link d-block col-12 text-left rounded-4 px-20 py-15 js-search-option">
                            <div class="d-flex">
                              <div class="icon-location-2 text-light-1 text-20 pt-4"></div>
                              <div class="ml-10">
                                <div class="text-15 lh-12 fw-500 js-search-option-target">Ba Vì</div>
                                <div class="text-14 lh-12 text-light-1 mt-5">Ba Vì, Hà Nội</div>
                              </div>
                            </div>
                          </button>
                        </div>
                ...
                <div class="searchMenu-guests px-30 lg:py-20 lg:px-0 js-form-dd js-form-counters">
                  ...
                  <div class="d-flex" data-x-dd-click="searchMenu-guests">
                    ...
                    <div class="ml-10">
                      <h4 class="text-15 fw-500 ls-2 lh-16">Lượng người</h4>
                    ...
                    <div class="bg-white px-30 py-30 rounded-4">
                      ...
                      <div class="row y-gap-10 justify-between items-center">
                        <div class="col-auto">
                          ...
                          <div class="text-14 lh-12 text-light-1 mt-5">Tuổi 0 - 17</div>
                        </div>
