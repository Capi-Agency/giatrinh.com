            ...
            <div class="row y-gap-10 items-center justify-between">
                <div class="col-auto">
                    <div class="row x-gap-10 y-gap-5 items-center text-14 text-light-1">
                        ...
                        <div class="col-auto">
                            <div class="text-dark-1"><a href="#">Mua hộ vé máy bay</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row y-gap-30">
          <div class="row pt-50 col-12">
            ...
            <div>
              ...
              Mẹo săn vé máy bay giá rẻ:<br>
                  Cách đặt vé máy bay trong nước <br>
                  Bạn truy cập thường xuyên hệ thống đặt vé máy bay trực tuyến, Giatrinh.com Hãy theo dõi fanpage chúng tôi : Gia Trinh. Thông tin liên tục được làm mới từ đội ngũ booker trên trang này. Hotline hỗ trợ trực tuyến 24/7 : zalo, messenger, telegram .. . 098 258 8080. Cần là có, tìm là thấy giá vé tốt nhất.
                  <ol>
          ...
          <div data-anim-child="slide-up delay-2" class="col-lg-4 col-sm-6 is-in-view">
            ...
            <div class="featureIcon -type-1 -hover-shadow px-50 py-50 lg:px-24 lg:py-15">
              ...
              <div class="text-center mt-30">
                ...
                <p class="text-15 mt-10">Chọc lọc giá từ nhiều đối tác, báo giá chính xác đến từng địa điểm. Có xuất hóa đơn đỏ</p>
              </div>
            </div>
